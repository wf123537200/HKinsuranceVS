...
export default async function CriticalIllnessRankingsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Critical Illness Rankings</h1>
      <p className="text-gray-600 mb-8">Rankings of critical illness insurance products by views.</p>
